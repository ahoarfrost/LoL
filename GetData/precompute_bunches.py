...
max_seqs=1000 #this will total about 20-25M seqs in databunch
...
print('creating databunch for chunk',chunk,'with skiprows',skiprows)
data_outfile = 'chunk_'+str(chunk)+'.pkl'
