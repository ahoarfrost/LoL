...
#SBATCH --job-name=gettbunch          # Assign an short name to your job
...
#SBATCH --output=slurm.precompute_testbunch.out    # STDOUT output file 

python precompute_testbunch.py
