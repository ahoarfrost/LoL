...
#SBATCH --output=slurm.comparem_GTDBrepGenomes.out    # STDOUT output file 

comparem aai_wf --cpus 28 /scratch/ah1114/LoL/data/GTDBrepGenomes /scratch/ah1114/LoL/data/GTDBrepGenomes_CompareMout
