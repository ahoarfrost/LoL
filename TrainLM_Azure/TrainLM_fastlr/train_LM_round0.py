...
#load presaved model (if not first round)
#learn.load('/home/horcrux/TrainLM/models/train_LM_latest_round0_epoch14')
...
#first round train 15 cycles with 8e-3 lr
train_round(learn, rnd=str(0), num_cycles=15, lrate=1e-2)

#future rounds will look like this:
#second round of training 15 cycles with lrate 5e-4
#load presaved model
#learn.load('/home/horcrux/TrainLM/models/train_LM_latest_round0_epoch14')
