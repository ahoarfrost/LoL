...
model_path = Path('/home/ah1114/LanguageOfLife/TaxClassification/models/test_taxclas')
log_path = Path('/home/ah1114/LanguageOfLife/TaxClassification/train_logs/test_taxclas')
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'

data_path = Path('/scratch/ah1114/LoL/data/testGenomes_csv/')

lr_plot_out = '/home/ah1114/LanguageOfLife/TaxClassification/test_taxclas.png'
...
print('there are',data.c,'classes with the labels:',data.classes)

config = awd_lstm_clas_config.copy() #make sure this is awd_lstm_clas_config for classification!
config['bidir'] = True #this can be True for classification
