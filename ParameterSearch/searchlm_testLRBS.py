...
batch_sizes = [1024]#[256, 512, 1024, 2048] 
max_seqs=None
#lrate=5e-3 
num_cycles=5
drop_mult=0.2
...
for lrate in learning_rates:
    for bs in batch_sizes:
        print('testing lr',lrate,'and bs',bs)
        model_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/lr'+str(lrate)+'_bs'+str(bs))
        model_dir = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/')
        log_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/train_logs/lr'+str(lrate)+'_bs'+str(bs))
        lr_plot_out = '/home/ah1114/LanguageOfLife/ParameterSearch/lr_plots/lrplot_lr'+str(lrate)+'_bs'+str(bs)+'.png'
