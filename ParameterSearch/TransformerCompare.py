...
model_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/Transformer3')
model_dir = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/')
log_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/train_logs/Transformer3')
lr_plot_out = '/home/ah1114/LanguageOfLife/ParameterSearch/lr_plots/lrplot_transformer3.png'
...
learn = language_model_learner(data, Transformer, model_dir=model_dir, config=config, pretrained=False).to_fp16()
...
learn.fit_one_cycle(num_cycles,lrate)
