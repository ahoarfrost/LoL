...
model_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/RandomSearch_full')
model_dir = Path('/home/ah1114/LanguageOfLife/ParameterSearch/models/')
log_path = Path('/home/ah1114/LanguageOfLife/ParameterSearch/train_logs/RandomSearch_full')
#lr_plot_out = '/home/ah1114/LanguageOfLife/ParameterSearch/lr_plots/RandomSearch.png'

with open('SearchParams_parsedclass.tsv') as f:  
    for line in f:  
