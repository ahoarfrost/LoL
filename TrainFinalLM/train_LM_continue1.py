...
path = Path('./') 
best_model_path = Path('/home/ah1114/LanguageOfLife/TrainFinalLM/models/train_LM_best_continue1')
...
lr_plot_out = '/home/ah1114/LanguageOfLife/TrainFinalLM/plots/lrplot_train_LM_continue1.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TrainFinalLM/plots/lossesplot_train_LM_continue1.png'
plot_lr_out = '/home/ah1114/LanguageOfLife/TrainFinalLM/plots/plotlr_train_LM_continue1.png'
...
#load presaved model
learn.load('/home/ah1114/LanguageOfLife/TrainFinalLM/models/train_LM_latest_round0_epoch14')
...
print('training first of four rounds of 15 cycle/s with lrate 5e-4')
learn.lr_find(wd=wd)
lr_plot = learn.recorder.plot(return_fig=True)
