...
learn.load('/home/ah1114/LanguageOfLife/TransferLearningTasks/MetalBinding/models/metalbinding_clas_round0_best')
...
learn.freeze_to(-2)
rnd=str(1)
train_round(learn, rnd=rnd, num_cycles=3, lrate= slice(2e-3/50,2e-3))
