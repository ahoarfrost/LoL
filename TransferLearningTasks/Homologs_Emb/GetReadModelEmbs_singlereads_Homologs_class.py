...
pretrained_path = Path('/home/ah1114/LanguageOfLife/saved_models/GTDB_read_LM_lowlr_continue4_best')
...
outfile = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/OG_SeqEmbs_class.pkl')
