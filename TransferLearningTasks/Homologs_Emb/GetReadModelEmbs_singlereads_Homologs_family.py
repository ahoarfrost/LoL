...
data_inpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/OG_seqs_family/')
all_outfile = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/LookingGlass_HomEmb_out/OG_SeqEmbs_family.pkl')
outpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/HomEmb_pkl_family/')
