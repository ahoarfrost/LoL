...
data_inpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/OG_seqs_order/')
all_outfile = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/LookingGlass_HomEmb_out/OG_SeqEmbs_order.pkl')
outpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/HomEmb_pkl_order/')
