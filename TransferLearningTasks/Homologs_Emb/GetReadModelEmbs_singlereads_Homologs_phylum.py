...
data_inpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/OG_seqs_phylum/')
all_outfile = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/LookingGlass_HomEmb_out/OG_SeqEmbs_phylum.pkl')
outpath = Path('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/HomEmb_pkl_phylum/')
...
for ix,fna in enumerate(contents):
    ...
    tax = fna.parts[-2]
    og = fna.stem
    outfile = str(outpath/tax/og)+'.pkl'
    #if outpath/tax doesn't exist, create it (and its parents if necessary)
