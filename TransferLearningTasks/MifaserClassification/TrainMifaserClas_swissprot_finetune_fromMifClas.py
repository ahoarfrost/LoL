...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/models/mifaserclas_swissprot_fromMif_best')
last_model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/models/mifaserclas_fromMif_swissprot')
model_dir = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/models/')
cache_dir = 'tmp_mifaserclas_swissprot_fromMif'
...
log_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/train_logs/mifaserclas_swissprot_fromMif')
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'
data_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/MifaserFn/swissprot/')
train_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/MifaserFn/swissprot/train/')
valid_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/MifaserFn/swissprot/valid/') 
lr_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/plots/lrplot_mifaserclas_swissprot_fromMif.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/plots/lossesplot_mifaserclas_swissprot_fromMif.png'
...
learn.callbacks.append(SaveModelCallback(learn, every='improvement', monitor='accuracy', name=model_path)) #save best model if accuracy is above the best seen so far this round
...
#round1
learn.freeze_to(-2)
learn.fit_one_cycle(10, slice(1e-3/(2.6**4),1e-3), moms=(0.8,0.7)) #this 2.6 rule of thumb is for NLP, maybe doesn't hold... but we'll go with it for now
#round2
learn.freeze_to(-3)
