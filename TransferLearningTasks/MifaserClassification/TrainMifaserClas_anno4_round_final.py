...
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLM/models/mifaserclas4round/')
cache_dir = 'tmp_mifaserclas4_round'
encoder_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/models/mifaserclas_anno4_enc_round')
...
lr_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/plots/lrplot_mifaserclas_anno4_round.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/MifaserClassification/plots/lossesplot_mifaserclas_anno4_round.png'
...
for round in range(0,numrounds):
    ...
    print('saving model and enc for round',round)
