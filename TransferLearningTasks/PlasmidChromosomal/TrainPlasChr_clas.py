...
path = Path('./') 
data_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/PlasmidChromosomal/')
train_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/PlasmidChromosomal/PlasmidChromosomal_genusparsed_train.csv')
valid_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/PlasmidChromosomal/PlasmidChromosomal_genusparsed_valid.csv')
model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/PlasmidChromosomal/models/plasmidchromosome_clas_best_man2')
last_model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/PlasmidChromosomal/models/plasmidchromosome_clas')
log_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/PlasmidChromosomal/train_logs/plasmidchromosome_clas_log_man2')
lr_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/PlasmidChromosomal/plots/lrplot_plasmidchromosome_clas_man2.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/PlasmidChromosomal/plots/lossesplot_plasmidchromosome_clas.png'
pretrained_path = Path('/home/ah1114/LanguageOfLife/saved_models/GTDB_read_LM_enc_lowlr_continue2_enc')
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'  
cache_dir = 'tmp_plaschr_clas' #otherwise your tmp recorder stuff will all go in the same place if you're running multiple jobs
...
data = BioClasDataBunch.from_df(path=data_path,train_df=train_df,valid_df=valid_df,
                tokenizer=tok, vocab=model_voc, classes=['plasmid','chromosome'],
                text_cols='seq',label_cols='plasmid_chromosome',
                bs=bs,device=device
                )
...
learn.freeze()
learn.fit_one_cycle(2,lrate, moms=(0.8,0.7))
#learn.fit_one_cycle(10,1e-2, moms=(0.8,0.7))
learn.freeze_to(-2)
learn.fit_one_cycle(2, slice(1e-3/(2.6**4),1e-3), moms=(0.8,0.7)) #this 2.6 rule of thumb is for NLP, maybe doesn't hold... but we'll go with it for now
