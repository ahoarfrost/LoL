...
bs=8192 #2048 works on 28 cpu; 4096 works; 8192 works; 16384 works; 32768 bus error; 8192 and 16384 take equal time to run for same amt data (32000 seqs); 4096 is only slightly longer; 2048 is significantly slower
ksize=1
skiprows=0
...
outfile = '/scratch/ah1114/LoL/TransferLearningTasks/EC1/metagenomes/'+str(metagenome_id)+'_cut_predictions.csv'
