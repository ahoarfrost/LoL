...
bs=2048 #2048 works on 28 cpu; 4096 works; 8192 works; 16384 works; 32768 bus error; 8192 and 16384 take equal time to run for same amt data (32000 seqs, ~1.5min); 4096 is only slightly longer; 2048 is significantly slower; 8192 seems to be the sweet spot
ksize=1
skiprows=0
...
path = Path('./') 
data_path = Path('/scratch/ah1114/LoL/TransferLearningTasks/EC1/TARA_metagenomes/')
metagenome_path = str(metagenome_id)+'_cut20M.fastq'
outfile = '/scratch/ah1114/LoL/TransferLearningTasks/EC1/TARA_metagenomes/'+str(metagenome_id)+'_cut_20M_predictions.csv'
