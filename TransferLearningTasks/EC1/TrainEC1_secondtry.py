...
model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_best')
last_model_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas')
log_path = Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/train_logs/ec1_clas_log')
lr_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/plots/lrplot_ec1_clas.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/plots/lossesplot_ec1_clas.png'
...
learn.freeze()
rnd=str(0)
callbacks = [SaveModelCallback(learn, every='improvement', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd+'_best')),
                SaveModelCallback(learn, every='epoch', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd)),
                CSVLogger(learn, filename=log_path, append=True)]
learn.fit_one_cycle(10,1e-2, moms=(0.8,0.7), callbacks=callbacks)
...
callbacks = [SaveModelCallback(learn, every='improvement', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd+'_best')),
                SaveModelCallback(learn, every='epoch', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd)),
                CSVLogger(learn, filename=log_path, append=True)]
learn.fit_one_cycle(5, slice(5e-3/50,5e-3), moms=(0.8,0.7), callbacks=callbacks) # 2.6**4 (not quite 50) is a rule of thumb is for NLP, maybe doesn't hold... but we'll go with it for now
...
callbacks = [SaveModelCallback(learn, every='improvement', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd+'_best')),
                SaveModelCallback(learn, every='epoch', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd)),
                CSVLogger(learn, filename=log_path, append=True)]
learn.fit_one_cycle(5, slice(1e-3/50,1e-3), moms=(0.8,0.7), callbacks=callbacks) 
learn.unfreeze()
rnd=str(3)
callbacks = [SaveModelCallback(learn, every='improvement', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd+'_best')),
                SaveModelCallback(learn, every='epoch', monitor='accuracy', name=Path('/home/ah1114/LanguageOfLife/TransferLearningTasks/EC1/models/ec1_clas_round'+rnd)),
                CSVLogger(learn, filename=log_path, append=True)]
learn.fit_one_cycle(5, slice(5e-4/50,5e-4), moms=(0.8,0.7), callbacks=callbacks) 
