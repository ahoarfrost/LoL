...
train_counts,total_train = count_seqs('/scratch/ah1114/LoL/data/GTDB_chunked_train_parsedclass/')
...
valid_counts,total_valid = count_seqs('/scratch/ah1114/LoL/data/GTDB_chunked_valid_parsedclass/')
...
test_counts,total_test = count_seqs('/scratch/ah1114/LoL/data/GTDB_chunked_test_parsedclass/')
