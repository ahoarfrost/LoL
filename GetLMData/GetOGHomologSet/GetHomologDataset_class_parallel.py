...
fout = '/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/uniprot2cds_class/uniprot2cds_class_parallel.tsv'
...
rename = pd.read_csv('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/uniprot2cds_class/uniprot2cds_class_parallel.tsv',sep='\t')
rename.columns = ['externalID','EMBLcdsID']
rename.to_csv('/scratch/ah1114/LoL/TransferLearningTasks/Homologs_Emb/uniprot2cds_class/uniprot2cds_class.csv',index=False)
