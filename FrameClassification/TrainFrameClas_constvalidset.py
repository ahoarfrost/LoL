...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/FrameClassification/models/frameclas_k1_constvalidset')
pretrained_path = Path('/home/ah1114/LanguageOfLife/FrameClassification/models/frameclas_k1')
log_path = Path('/home/ah1114/LanguageOfLife/FrameClassification/train_logs/frameclas_k1_constvalidset')
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'

#data_path = Path('/scratch/ah1114/LoL/data/GTDBrepCDS_chunked_csv/')
data_path = Path('/scratch/ah1114/LoL/data/GTDBrepCDS_chunked_csv')
train_path = Path('/scratch/ah1114/LoL/data/GTDBrepCDS_chunked_csv')
valid_path = Path('/scratch/ah1114/LoL/data/GTDBrepCDS_chunked_csv/valid')

lr_plot_out = '/home/ah1114/LanguageOfLife/FrameClassification/lrplot_frameclas_k1_constvalidset.png'
#if stuck with 128GB, might try doing it in shuffled batches of files?
bs=8192 #2048 worked in previous tests, 4096 had memory error
ksize=1
stride=1
max_seqs=100 
valid_max_seqs=100000
lrate=1e-3 #adjusted down after seeing lrplot
drop_mult=0.3 #haven't tuned this at all yet
num_cycles=1
numrounds=5
skiprows_file = "skiprows_constvalidset.csv"
