...
df = pd.read_pickle('/home/ah1114/LanguageOfLife/Interpret/InterpretBacPDB_Embs.pkl')
...
with open(fout, 'a') as outfile:
    ...
    #writer.writerow(['combo','seq_similarity','emb_similarity','structure_similarity'])
