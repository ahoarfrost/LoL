...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/TrainLM/models/GTDB_read_LM_lowlr_continue2_best')
last_model_path = Path('/home/ah1114/LanguageOfLife/TrainLM/models/GTDB_read_LM_lowlr_continue2')
last_encoder_path = Path('/home/ah1114/LanguageOfLife/TrainLM/models/GTDB_read_LM_enc_lowlr_continue2')
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLM/models/lowlr_continue2/')
log_path = Path('/home/ah1114/LanguageOfLife/TrainLM/train_logs/log_GTDB_read_LM_lowlr_continue2')
data_path = Path('/scratch/ah1114/LoL/data/')
presaved_databunch = 'GTDB_class_databunch.pkl'
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'
lr_plot_out = '/home/ah1114/LanguageOfLife/TrainLM/plots/lrplot_GTDB_read_LM_lowlr_continue2.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TrainLM/plots/lossesplot_GTDB_read_LM_lowlr_continue2.png'
plot_lr_out = '/home/ah1114/LanguageOfLife/TrainLM/plots/plotlr_GTDB_read_LM_lowlr_continue2.png'
cache_dir = 'tmp_trainlm_lowlr_continue2' #otherwise your tmp recorder stuff will all go in the same place if you're running multiple jobs
...
#load presaved model
learn.load(Path('/home/ah1114/LanguageOfLife/TrainLM/models/GTDB_read_LM_lowlr_best'))
...
learn.fit_one_cycle(25,lrate, wd=wd, moms=moms)
