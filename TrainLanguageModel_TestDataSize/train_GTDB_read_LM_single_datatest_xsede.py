...
'''
path = Path('./') 
model_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_datatest_'+str(sys.argv[1]))
encoder_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_enc_datatest_'+str(sys.argv[1]))
log_path = Path('/home/horcrux/Wonderland/datatest/train_logs/log_GTDB_read_LM_datatest_'+str(sys.argv[1]))
#model_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_datatest_10')
#encoder_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_enc_datatest_10')
#log_path = Path('/home/horcrux/Wonderland/datatest/train_logs/log_GTDB_read_LM_datatest_10')
...
num_cycles=10
skiprows = np.random.choice(range(0,10000)) #choose a random skiprows
...
train = train.databunch(bptt=bptt,bs=bs)
