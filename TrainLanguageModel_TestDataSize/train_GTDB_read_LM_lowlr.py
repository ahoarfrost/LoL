...
model_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_lowlr')
encoder_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_lowlr_enc')
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/')
log_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/train_logs/log_GTDB_read_LM_lowlr')
...
skiprows_file = "skiprows_lowlr.csv"
val_skiprows_file = "val_skiprows.csv"
round_file = "total_rounds_lowlr.csv"
final_model=False
...
#lrate=8e-3 
#lrate=2e-3
lrate=1e-4 #cranking it way down
...
print('training round',total_rounds,'with skiprows',skiprows)
...
#if total_rounds==2: #get lr first round only
    print('loading initial saved model')
    learn.load(pretrained_start)
