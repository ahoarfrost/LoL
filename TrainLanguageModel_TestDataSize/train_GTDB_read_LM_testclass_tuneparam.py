...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_tuneclass_'+str(wd)+str(moms))
encoder_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_enc_tuneclass_'+str(wd)+str(moms))
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_tuneclass_'+str(wd)+str(moms)+'/')
log_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/train_logs/log_GTDB_read_LM_tuneclass_'+str(wd)+str(moms))
...
lr_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lrplot_GTDB_read_LM_tuneclass_'+str(wd)+str(moms)+'.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lossesplot_GTDB_read_LM_tuneclass_'+str(wd)+str(moms)
plot_lr_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/plotlr_GTDB_read_LM_tuneclass_'+str(wd)+str(moms)
...
cache_dir = 'tmp_tuneclass_'+str(wd)+str(moms) #otherwise your tmp recorder stuff will all go in the same place if you're running multiple jobs
...
print('training model with wd',wd,'and moms',moms)
...
learn.fit_one_cycle(10,lrate, wd=wd, moms=moms)
