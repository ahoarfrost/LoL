...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_tunedrop_'+str(drop_mult))
encoder_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_enc_tunedrop_'+str(drop_mult))
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_tunedrop_'+str(drop_mult)+'/')
log_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/train_logs/log_GTDB_read_LM_tunedrop_'+str(drop_mult))
...
lr_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lrplot_GTDB_read_LM_tunedrop_'+str(drop_mult)+'.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lossesplot_GTDB_read_LM_tunedrop_'+str(drop_mult)
plot_lr_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/plotlr_GTDB_read_LM_tunedrop_'+str(drop_mult)
...
cache_dir = 'tmp_tunedrop_'+str(drop_mult) #otherwise your tmp recorder stuff will all go in the same place if you're running multiple jobs
...
print('training model with drop_mult',drop_mult)
