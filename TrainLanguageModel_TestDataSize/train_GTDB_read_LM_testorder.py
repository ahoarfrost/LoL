...
path = Path('./') 
model_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_testorder_2')
encoder_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_enc_testorder_2')
model_dir = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/models/GTDB_read_LM_testorder/') #so tmp model will go here
cache_dir = 'tmp_testorder' #otherwise your tmp recorder stuff will all go in the same place if you're running multiple jobs
log_path = Path('/home/ah1114/LanguageOfLife/TrainLanguageModel/train_logs/log_GTDB_read_LM_testorder_2')
data_path = Path('/scratch/ah1114/LoL/data/')
#presaved_validset = 'GTDBdatabunch_validonly.pkl'
#presaved_databunch = 'GTDB_trainorder_databunch.pkl' # got memory error when tried to load_data
vocab_path = Path('/home/ah1114/LanguageOfLife/vocabs')
vocab_name = vocab_path/'ngs_vocab_k1_withspecial.npy'
lr_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lrplot_GTDB_read_LM_testorder_2.png'
losses_plot_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/lossesplot_GTDB_read_LM_testorder_2.png'
plot_lr_out = '/home/ah1114/LanguageOfLife/TrainLanguageModel/plots/plotlr_GTDB_read_LM_testorder_2.png'
...
learn = learn.to_my_distributed(args.local_rank,cache_dir=cache_dir)
