...
path = Path('./') 
model_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_testchunk')
encoder_path = Path('/home/horcrux/Wonderland/datatest/models/GTDB_read_LM_enc_testchunk')
model_dir = Path('/home/horcrux/Wonderland/datatest/models/')
log_path = Path('/home/horcrux/Wonderland/datatest/train_logs/log_GTDB_read_LM_testchunk')
...
lr_plot_out = '/home/horcrux/Wonderland/datatest/lrplot_GTDB_read_LM_testchunk.png'
train_path = Path('/pylon5/eaz3a2p/horcrux/Wonderland/GTDB_chunked_trainparsed')
